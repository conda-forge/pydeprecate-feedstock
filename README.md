...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pydeprecate-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pydeprecate-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pydeprecate
# for installing globally
pixi global install pydeprecate
```
...
It is possible to list all of the versions of `pydeprecate` available on your platform:
...
```
pixi search pydeprecate --channel conda-forge
```
